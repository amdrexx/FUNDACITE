...
<div class="sidebar" id="sidebar" style="display: flex; flex-direction: column; justify-content: space-between; height: calc(102vh - 70px);">
    <ul style="list-style: none; padding: 0; margin: 0;">
        ...
        <li>
            <a href="/FUNDACITE/vistas/lista_solicitudes.php" class="submenu-link">
...
<div class="main">
    <div class="dashboard-container">
        ...
        <div class="cards">
            <div class="card">
                <div class="icon">
                    <img src="/FUNDACITE/vistas/img/persona_activa.png" alt="icono">
                </div>
            ...
            <div class="card">
                <div class="icon">
                    <img src="/FUNDACITE/vistas/img/persona_jubilada.png" alt="icono">
                </div>
            ...
            <div class="card">
                <div class="icon">
                    <img src="/FUNDACITE/vistas/img/persona_inactiva.png" alt="icono">
                </div>
